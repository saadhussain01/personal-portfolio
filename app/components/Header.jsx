...
const Header = () => {
  return (
    <div id="home" className="relative w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
      ...
      >
        I am a passionate AI/ML Engineer with expertise in building and training
        ML models and AI Powered applications.
      </motion.p>
